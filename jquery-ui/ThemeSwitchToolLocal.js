(function($) {
    ...
    $.fn.themeswitcher = function(options) {
            ...
            var themes = [
    			{
    			    ...
    			    url: "css/theme/ui.black-tie.css"
    			},
    			{
    			    title: "Blitzer",
    			    name: "blitzer",
    			    icon: "theme_90_blitzer.png",
    			    url: "css/theme/ui.blitzer.css"
    			},
    			{
    			    title: "Cupertino",
    			    name: "cupertino",
    			    icon: "theme_90_cupertino.png",
    			    url: "css/theme/ui.cupertino.css"
    			},
    			{
    			    title: "Dark Hive",
    			    name: "dark-hive",
    			    icon: "theme_90_dark_hive.png",
    			    url: "css/theme/ui.dark-hive.css"
    			},
    			{
    			    title: "Dot Luv",
    			    name: "dot-luv",
    			    icon: "theme_90_dot_luv.png",
    			    url: "css/theme/ui.dot-luv.css"
    			},
    			{
    			    title: "Eggplant",
    			    name: "eggplant",
    			    icon: "theme_90_eggplant.png",
    			    url: "css/theme/ui.eggplant.css"
    			},
    			{
    			    title: "Excite Bike",
    			    name: "excite-bike",
    			    icon: "theme_90_excite_bike.png",
    			    url: "css/theme/ui.excite-bike.css"
    			},
    			{
    			    title: "Flick",
    			    name: "flick",
    			    icon: "theme_90_flick.png",
    			    url: "css/theme/ui.flick.css"
    			},
    			{
    			    title: "Hot Sneaks",
    			    name: "hot-sneaks",
    			    icon: "theme_90_hot_sneaks.png",
    			    url: "css/theme/ui.hot-sneaks.css"
    			},
    			{
    			    title: "Humanity",
    			    name: "humanity",
    			    icon: "theme_90_humanity.png",
    			    url: "css/theme/ui.humanity.css"
    			},
    			{
    			    title: "Le Frog",
    			    name: "le-frog",
    			    icon: "theme_90_le_frog.png",
    			    url: "css/theme/ui.le-frog.css"
    			},
    			{
    			    title: "Mint Choc",
    			    name: "mint-choc",
    			    icon: "theme_90_mint_choco.png",
    			    url: "css/theme/ui.mint-choc.css"
    			},
    			{
    			    title: "Overcast",
    			    name: "overcast",
    			    icon: "theme_90_overcast.png",
    			    url: "css/theme/ui.overcast.css"
    			},
    			{
    			    title: "Pepper Grinder",
    			    name: "pepper-grinder",
    			    icon: "theme_90_pepper_grinder.png",
    			    url: "css/theme/ui.pepper-grinder.css"
    			},
    			{
    			    title: "Redmond",
    			    name: "redmond",
    			    icon: "theme_90_windoze.png",
    			    url: "css/theme/ui.redmond.css"
    			},
    			{
    			    title: "Smoothness",
    			    name: "smoothness",
    			    icon: "theme_90_smoothness.png",
    			    url: "css/theme/ui.smoothness.css"
    			},
    			{
    			    title: "South Street",
    			    name: "south-street",
    			    icon: "theme_90_south_street.png",
    			    url: "css/theme/ui.south-street.css"
    			},
    			{
    			    title: "Start",
    			    name: "start",
    			    icon: "theme_90_start_menu.png",
    			    url: "css/theme/ui.start.css"
    			},
    			{
    			    title: "Sunny",
    			    name: "sunny",
    			    icon: "theme_90_sunny.png",
    			    url: "css/theme/ui.sunny.css"
    			},
    			{
    			    title: "Swanky Purse",
    			    name: "swanky-purse",
    			    icon: "theme_90_swanky_purse.png",
    			    url: "css/theme/ui.swanky-purse.css"
    			},
    			{
    			    title: "Trontastic",
    			    name: "trontastic",
    			    icon: "theme_90_trontastic.png",
    			    url: "css/theme/ui.trontastic.css"
    			},
    			{
    			    title: "UI Darkness",
    			    name: "ui-darkness",
    			    icon: "theme_90_ui_dark.png",
    			    url: "css/theme/ui.ui-darkness.css"
    			},
    			{
    			    title: "UI Lightness",
    			    name: "ui-lightness",
    			    icon: "theme_90_ui_light.png",
    			    url: "css/theme/ui.ui-lightness.css"
    			},
    			{
    			    title: "Vader",
    			    name: "vader",
    			    icon: "theme_90_black_matte.png",
    			    url: "css/theme/ui.vader.css"
    			}
    		]
        } else {
        ...
        var switcherListHldr = $("<div/>")
    		...
    		.css({
    		    "width": eval(settings.width + 20) + "px",
    		    "background": "#000",
    		    "color": "#FFF",
    		    "font-family": "'Trebuchet MS', Verdana, sans-serif",
    		    "font-size": "12px",
    		    ...
    		    "z-index": "999999",
    		    "position": "absolute",
    		    // "top": eval(settings.buttonheight - 14) + "px",
    		    "bottom": "2px",
    		    "left": "0px",
        ...
        function updateTheme(data) {
            ...
            if ($("#ui-theme").length == 0) {
                ...
                $("#ui-theme").attr("href", (data.url) ? data.url : ("http://ajax.googleapis.com/ajax/libs/jqueryui/" + settings.jqueryuiversion + "/themes/" + data.name + "/jquery-ui.css"));
            }




            $.cookie(settings.cookiename, data.name, { "expires": 100 });
        ...
        function openSwitcher() {
            ...
            switcherDiv.find(".jquery-ui-switcher-list-hldr").show('Clip'); //.slideUp("fast");
        }
        ...
        function closeSwitcher() {
            ...
            switcherDiv.find(".jquery-ui-switcher-list-hldr").hide('Clip', function() {//.slideDown("fast", function() {
                switcherDiv.find(".jquery-ui-switcher-link").css({
                    "color": "#666",
                    "background": "#eee url(" + settings.imgpath + "buttonbg.png) repeat-x 50% 50%"
                });
